                    ...
                    Column(modifier = Modifier.padding(10.dp)) {
                        muscleVolumeMap.forEach { (muscle, setCount) ->
                            Row(
                                ...
                                Text(text = stringResource(R.string.summary_sets_count, setCount), color = NeonLime, fontSize = 12.sp, fontWeight = FontWeight.Bold)
                            }
                        }
                    }
                }
                    ...
                    Column(modifier = Modifier.padding(10.dp)) {
                        segments.forEachIndexed { idx, segmentItem ->
                            Row(
                                ...
                                Text(text = stringResource(R.string.summary_segment, idx + 1, segmentItem.category.label()), color = TextPrimary, fontSize = 12.sp)
                                Text(text = stringResource(R.string.summary_sets_count, segmentItem.setCount), color = AmberGold, fontSize = 12.sp, fontWeight = FontWeight.Bold)
                            }
                        }
                    }
                }
