...
fun LiveWorkoutSetOptionsDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(R.string.workout_live_set_number, setIndexDisplay),
                color = NeonLime,
                fontSize = 14.sp,
        ...
        dismissButton = {
            TextButton(onClick = onDismiss) {
                Text(text = stringResource(R.string.action_close), color = TextMuted, fontSize = 12.sp, fontWeight = FontWeight.Bold)
            }
        }
    )
}
