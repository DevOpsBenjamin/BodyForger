...
val dataModule = module {
    ...
    single { app.bodyforger.mobile.mcp.McpAuthManager(preferences = get()) }
    single { app.bodyforger.mobile.mcp.McpHttpServer(dispatcher = get(), toolRegistry = get(), authManager = get()) }
