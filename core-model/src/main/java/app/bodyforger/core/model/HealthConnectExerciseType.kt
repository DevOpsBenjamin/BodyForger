 ...
 * Every exercise segment type officially recognised by the Android Health Connect API
 * (androidx.health.connect.client.records.ExerciseSegmentType).
 *
 * This catalogue is the canonical base guaranteeing lossless synchronisation with Google
 * Health Connect, Google Fit and Samsung Health. [canonicalNameFr] is display data for the
 * French locale, not a comment.
 */
