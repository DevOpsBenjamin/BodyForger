...
### Why this project?
As an active user of commercial fitness apps like **Hevy**, I became dissatisfied with the limitations of their smartwatch companion (lack of true standalone autonomy, screen-off/ambient mode issues, rest timer inconsistencies) and the shallow integration with **Google Health Connect**.
