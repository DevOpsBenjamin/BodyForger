...
object HuaweiFraming {
    ...
    /** The CRC-16 CCITT polynomial, from which the table below follows entirely. */
...
class HuaweiFrameReassembler {
    ...
    /** Where the frames being reassembled came from, while a payload is still incomplete. */
